package rfid.DoorControl.src.com.cn.activity.ui;

import gnu.io.PortInUseException;
import gnu.io.SerialPort;
import rfid.DoorControl.src.com.cn.activity.manager.SerialPortManager;
import rfid.DoorControl.src.com.cn.activity.utils.ByteUtils;
import rfid.DoorControl.src.com.cn.activity.utils.ShowUtils;
import rfid.DoorControl.src.com.cn.peopleInfo.people;
import rfid.DoorControl.src.com.cn.util.operationIc;
import rfid.DoorControl.src.com.cn.util.uiInfo;
...
public class MainFrame extends JFrame {
    ...
    private JButton mSerialPortOperate = new JButton("打开串口");
     JButton mSendData = new JButton("发送数据");
//    mSendData.addActionListener(new ActionListener(){
//        public void actionPerformed(ActionEvent e){
//            mOperatePanel.setVisible(true);
//            uiInfo uiInfo=new uiInfo();
//            uiInfo.txtIdCard.setText(mDataView.getText());
//        }
//    });
    // 串口列表
    ...
    public String remDataView()
    {
        return mDataView.getText();
    }
    /**
     * 初始化窗口
     */
    ...
    private void initData() {
        mCommList = (List<String>) SerialPortManager.findPorts();
        // 检查是否有可用串口，有则加入选项中
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                System.out.println(new MainFrame().mDataView.getText());
            }
        });
